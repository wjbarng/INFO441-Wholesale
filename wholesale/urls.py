...
urlpatterns = [
    ...
    path('categories/23/products', views.products, name='products'), 
    path('categories/<int:category_name>/products/<int:product_id>', views.product_detail, name='product detail'), 
